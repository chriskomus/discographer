...
class LabelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create label" do
    assert_difference("Label.count") do
      post labels_url, params: { label: { id: @label.id, name: @label.name, profile: @label.profile } }
    end
  ...
  test "should update label" do
    patch label_url(@label), params: { label: { id: @label.id, name: @label.name, profile: @label.profile } }
